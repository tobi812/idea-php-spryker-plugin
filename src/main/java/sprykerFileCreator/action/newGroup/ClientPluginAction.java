...
public class ClientPluginAction extends AbstractClassTypeAction {

    public ClientPluginAction() {
        super("Create Client Plugin", "Create Client Plugin", SprykerIcons.SPRYKER_ICON);
    }
